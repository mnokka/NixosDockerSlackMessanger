...
# 3.5.2023 mika.nokka1@gmail.com
#
# Slack idea from https://howchoo.com/python/python-send-slack-messages-slackclient
# See web page for Slack app creation/configuration magic
#
# Python Slaclient nixos installation via shebang
#
# ENV variable SLACKTOKEN assumed to include token for Slack app usage
# (export SLACKTOKEN=MY_SLACK_GIVEN_TOKEN_TO_MY_APP)
#
# Execute via syntax:  ./messager.py 
